        ...
        <div class="row">
            <form action="{{ url('admin/editHangjiaRes') }}" method="post" class="add-article-form" enctype="multipart/form-data">
                ...
                <div class="col-md-9">
                    ...
                    <div class="form-group">
                        <label for="article-title" class="">行家电话</label>
                        <input type="text" id="tel" name="tel" class="form-control" placeholder="在此处输入行家电话" value="{{ $res['tel'] }}" required autofocus autocomplete="off">
                    </div>
